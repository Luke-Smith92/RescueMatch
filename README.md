...
![Python Linter - manage.py](rescuematch/static/screenshots/python-linter-manage.png)

### settings.py

The `settings.py` file was validated using the Code Institute Python Linter.

![Python Linter - settings.py](rescuematch/static/screenshots/python-linter-settings.png)

### views.py

The `views.py` file was validated using the Code Institute Python Linter.

![Python Linter - views.py](rescuematch/static/screenshots/python-linter-views.png)

### models.py

The `models.py` file was validated using the Code Institute Python Linter.

![Python Linter - models.py](rescuematch/static/screenshots/python-linter-models.png)

### forms.py

The `forms.py` file was validated using the Code Institute Python Linter.

![Python Linter - forms.py](rescuematch/static/screenshots/python-linter-forms.png)
